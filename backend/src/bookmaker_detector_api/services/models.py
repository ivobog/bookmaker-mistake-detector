...
def list_model_registry_in_memory(
    ...
    *,
    ...
    return model_training_views.list_model_registry_in_memory(
        repository,
        target_task=target_task,
    )
...
def list_model_training_runs_in_memory(
    ...
    *,
    ...
    return model_training_views.list_model_training_runs_in_memory(
        repository,
        target_task=target_task,
        team_code=team_code,
        season_label=season_label,
...
def get_model_training_run_detail_in_memory(
    ...
    *,
    ...
    return model_training_views.get_model_training_run_detail_in_memory(
        repository,
        run_id=run_id,
    )
...
def ensure_model_registry_in_memory(
    ...
    *,
    ...
    return model_training_lifecycle.ensure_model_registry_in_memory(
        repository,
        target_task=target_task,
        model_family=model_family,
        team_code=team_code,
...
def list_model_evaluation_snapshots_in_memory(
    ...
    *,
    ...
    return model_training_views.list_model_evaluation_snapshots_in_memory(
        repository,
        target_task=target_task,
        model_family=model_family,
    )
...
def get_model_evaluation_snapshot_detail_in_memory(
    ...
    *,
    ...
    return model_training_views.get_model_evaluation_snapshot_detail_in_memory(
        repository,
...
def get_model_training_summary_in_memory(
    ...
    *,
    ...
    return model_training_views.get_model_training_summary_in_memory(
        repository,
        target_task=target_task,
        team_code=team_code,
        season_label=season_label,
...
def get_model_training_history_in_memory(
    ...
    *,
    ...
    return model_training_views.get_model_training_history_in_memory(
        repository,
        target_task=target_task,
        team_code=team_code,
        season_label=season_label,
...
def get_model_evaluation_history_in_memory(
    ...
    *,
    ...
    return model_training_views.get_model_evaluation_history_in_memory(
        repository,
        target_task=target_task,
        model_family=model_family,
        recent_limit=recent_limit,
...
def list_model_selection_snapshots_in_memory(
    ...
    *,
    ...
    return model_training_views.list_model_selection_snapshots_in_memory(
        repository,
        target_task=target_task,
...
def get_model_selection_snapshot_detail_in_memory(
    ...
    *,
    ...
    return model_training_views.get_model_selection_snapshot_detail_in_memory(
        repository,
...
def list_model_scoring_runs_in_memory(
    ...
    *,
    ...
    return model_scoring_runs.list_model_scoring_runs_in_memory(
        repository,
        model_market_board_id=model_market_board_id,
        target_task=target_task,
        team_code=team_code,
...
def get_model_scoring_run_detail_in_memory(
    ...
    *,
    ...
    return model_scoring_runs.get_model_scoring_run_detail_in_memory(
        repository,
...
def get_model_scoring_history_in_memory(
    ...
    *,
    ...
    return model_scoring_runs.get_model_scoring_history_in_memory(
        repository,
        model_market_board_id=model_market_board_id,
        target_task=target_task,
        team_code=team_code,
...
def get_model_market_board_operations_in_memory(
    ...
    *,
    ...
    return model_market_board_orchestration.get_model_market_board_operations(
        board_id=board_id,
        list_boards=lambda: list_model_market_boards_in_memory(repository),
        list_source_runs=lambda **kwargs: list_model_market_board_source_runs_in_memory(
            repository,
            **kwargs,
        ),
        list_refresh_events=lambda **kwargs: list_model_market_board_refresh_events_in_memory(
            repository,
            **kwargs,
        ),
        list_scoring_runs=lambda **kwargs: list_model_scoring_runs_in_memory(repository, **kwargs),
        list_opportunities=lambda **kwargs: list_model_opportunities_in_memory(
            repository,
            **kwargs,
        ),
        list_refresh_batches=lambda: list_model_market_board_refresh_batches_in_memory(repository),
        list_cadence_batches=lambda: list_model_market_board_cadence_batches_in_memory(repository),
        list_scoring_batches=lambda: list_model_market_board_scoring_batches_in_memory(repository),
        recent_limit=recent_limit,
    )
...
def get_model_market_board_cadence_dashboard_in_memory(
    ...
    *,
    ...
    return model_market_board_orchestration.get_model_market_board_cadence_dashboard(
        ...
        source_name=source_name,
        recent_limit=recent_limit,
        list_boards=lambda **kwargs: list_model_market_boards_in_memory(repository, **kwargs),
        list_scoring_runs=lambda **kwargs: list_model_scoring_runs_in_memory(repository, **kwargs),
        list_scoring_batches=lambda **kwargs: list_model_market_board_scoring_batches_in_memory(
            repository,
            **kwargs,
        ),
    )
...
def score_model_market_board_in_memory(
    ...
    *,
    ...
    return model_market_board_orchestration.score_model_market_board(
        ...
        materialize_future_slate=lambda **kwargs: materialize_model_future_slate_in_memory(
            repository,
            **kwargs,
        ),
        serialize_market_board=_serialize_model_market_board,
...
def get_model_opportunity_detail_in_memory(
    ...
    *,
    ...
    return model_opportunities.get_model_opportunity_detail_in_memory(
        repository,
...
def get_model_opportunity_history_in_memory(
    ...
    *,
    ...
    return model_opportunities.get_model_opportunity_history_in_memory(
        repository,
        target_task=target_task,
        team_code=team_code,
        season_label=season_label,
...
def list_model_backtest_runs_in_memory(
    ...
    *,
    ...
    return model_backtest_runs.list_model_backtest_runs_in_memory(
        repository,
        target_task=target_task,
        team_code=team_code,
        season_label=season_label,
...
def get_model_backtest_history_in_memory(
    ...
    *,
    ...
    return model_backtest_runs.get_model_backtest_history_in_memory(
        repository,
        target_task=target_task,
        team_code=team_code,
        season_label=season_label,
...
def get_model_backtest_detail_in_memory(
    ...
    *,
    ...
    return model_backtest_runs.get_model_backtest_detail_in_memory(
        repository,
...
def get_model_selection_history_in_memory(
    ...
    *,
    ...
    return model_training_views.get_model_selection_history_in_memory(
        repository,
        target_task=target_task,
        recent_limit=recent_limit,
    )
...
def save_model_selection_snapshot_in_memory(
    ...
    *,
    ...
    return model_training_lifecycle.save_model_selection_snapshot_in_memory(
        repository,
        snapshot,
        selection_policy_name=selection_policy_name,
    )
